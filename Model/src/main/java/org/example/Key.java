...
public class Key {
    private Vector<Byte> finalKey = new Vector<Byte>();

    private Map<Integer, Integer> numberOfBytes = Map.of(16, 176, 24, 208, 32, 240); // mapa ostatecznej długości klucza
    ...
    private final int[] inverseSBox = new int[]{
